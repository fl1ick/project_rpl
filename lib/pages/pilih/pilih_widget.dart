...
import 'pilih_model.dart';
export 'pilih_model.dart';

class PilihWidget extends StatefulWidget {
  const PilihWidget({Key? key}) : super(key: key);

  @override
  _PilihWidgetState createState() => _PilihWidgetState();
}

class _PilihWidgetState extends State<PilihWidget> {
  late PilihModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PilihModel());
  }
            ...
            Align(
              ...
              child: Container(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed('calendelposyandu');
                  },
                  text: 'Pilih Jadwal',
